...
export function Globe(props) {
  ...
  const { nodes, materials, animations } = useGLTF("/globe.glb");
   ...
   useEffect(() => {
    const animate = () => {
      // Rotate the globe by a small amount in each frame
      group.current.rotation.y += 0.002;

      // You can also play any animations here if there are any in the glTF file
      // For example, if you have an animation called "rotationAnimation"
